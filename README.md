# authapi [![Build Status][1]][2] [![Coverage Status](https://coveralls.io/repos/agoravoting/authapi/badge.svg?branch=next)](https://coveralls.io/r/agoravoting/authapi?branch=next)
