...
urlpatterns = [
    ...
    url(r'^auth-event/(?P<pk>\d+)/ballot-box/$', views.ballot_box, name='census'),
    url(r'^auth-event/(?P<pk>\d+)/ballot-box/(?P<ballot_box_pk>\d+)/delete/$', views.ballot_box, name='census'),
